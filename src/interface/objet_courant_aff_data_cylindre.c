...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/09 14:25:43 by prossi            #+#    #+#             */
/*   Updated: 2018/04/18 15:02:10 by prossi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rt.h"

void	aff_data_cylindre_fh(t_stuff *e, char *buf)
{
...
void	aff_data_cylindre_td(t_stuff *e, char *buf)
{
	awklm_string_put(buf, e);
	ft_strclr(buf);
	...
	aff_data_cylindre_fh(e, buf);
}

void	aff_data_cylindre_sd(t_stuff *e, char *buf)
{
	awklm_string_put(buf, e);
	ft_strclr(buf);
