...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   terminal_aff_new_cylindre.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: prossi <prossi@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/15 14:33:31 by prossi            #+#    #+#             */
/*   Updated: 2018/04/17 14:14:58 by prossi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rt.h"

void	aff_new_cylindre_fih(t_stuff *e)
{
...
void	aff_new_cylindre_fh(t_stuff *e)
{
	if (e->i.nobj.first == 9)
	{
		mlx_string_put(e->img.mlx_ptr, e->img.win_ptr, 15, (WIN_Y - LENGTH) * \
	...
	aff_new_cylindre_fih(e);
}

void	aff_new_cylindre_td(t_stuff *e)
{
	if (e->i.nobj.first == 6)
	{
		mlx_string_put(e->img.mlx_ptr, e->img.win_ptr, 15, (WIN_Y - LENGTH) * \
	...
	aff_new_cylindre_fh(e);
}

void	aff_new_cylindre_sd(t_stuff *e)
{
	if (e->i.nobj.first == 3)
	{
		mlx_string_put(e->img.mlx_ptr, e->img.win_ptr, 15, (WIN_Y - LENGTH) * \
